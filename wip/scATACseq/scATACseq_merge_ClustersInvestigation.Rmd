...
dir.create(path = paste0(directory,"exp/","scATACseq_R_ClustersInvestigation/"))
dir.create(path = paste0(directory,"exp/","scATACseq_R_ClustersInvestigation/", current_date))
directory_output = paste0(directory,"exp/","scATACseq_R_ClustersInvestigation/", current_date, "/")
