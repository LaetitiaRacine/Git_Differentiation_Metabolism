...
directory_output = paste0(directory, "exp/scRNAseq_CITEseq_R_DWNS_PathwaysAnalysis/20230306/")
...
pathways_db_list = readRDS(paste0(directory_output, "pathways_database_reactome_format_scpa.rds"))
...
# saveRDS(object = list_scpa_cond, file = paste0(directory_output, "list_scpa_conditions.rds"))

list_scpa_cond = readRDS(paste0(directory_output, "list_scpa_conditions.rds"))
...
for (i in 1:length(list_scpa_cond)) {
  ...
  plot = ggplot(scpa_out, aes(x = FC, y = qval)) +
    ...
    geom_text_repel(data = scpa_out %>% dplyr::filter(qval > 5),
                    ...
                    force = 3, force_pull = 2, max.overlaps = 100) +
