...
dir.create(path = paste0(directory, "exp/scRNAseq_CITEseq_R_DWNS_ClustersStatistics_TestDownsampling/"))
dir.create(path = paste0(directory, "exp/scRNAseq_CITEseq_R_DWNS_ClustersStatistics_TestDownsampling/", current_date))
directory_output = paste0(directory, "exp/scRNAseq_CITEseq_R_DWNS_ClustersStatistics_TestDownsampling/", current_date, "/")
...
dir = pic_last_dir(paste0(directory, "exp/", "scRNAseq_CITEseq_R_ReductionDimension_TestDownsampling/"))
