...
# Normalize on initial cell number
cat("We don't start with the same number of cells in each condition. A 
    normalization step based on the initial number of cells per condition 
    is required to be able to compare the conditions.")
...
Graphic representation of the last tables.  
