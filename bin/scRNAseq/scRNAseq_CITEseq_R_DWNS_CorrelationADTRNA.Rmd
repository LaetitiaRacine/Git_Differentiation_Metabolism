...
We work from the count matrix from seurat object. The **"count"** slot contains raw data whereas the **"data"** slot contains normalized data with CLR algorithm. We use here the normalized data. 
```{r}
