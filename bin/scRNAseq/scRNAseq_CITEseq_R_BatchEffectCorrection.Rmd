...
It's better to normalize on individual object before merging or integrating.

Multiple possibilities :  
- there is no batch effect, we can just merge the data  
- there is a batch effect, we need to integrate both batches in one object
...
```{r, Focus on CTRL - Ind batch sct, fig.width = 10, fig.height = 6}

ctrl_batch1 = subset(merged_sct_batch1, orig.ident == "CTRL")
ctrl_batch2 = subset(merged_sct_batch2, orig.ident == "CTRL2")

# Show all conditions independently
ctrl_batch1_sct_umap_plot = DimPlot(object = ctrl_batch1, 
                                    reduction = "umap",
                                    group.by = "orig.ident",
                                    cols = color_code)
ctrl_batch2_sct_umap_plot = DimPlot(object = ctrl_batch2, 
                                    reduction = "umap",
                                    group.by = "orig.ident",
                                    cols = color_code)

ctrl_batch1_sct_umap_plot | ctrl_batch2_sct_umap_plot

```

```{r, Save outputs - Ind batch sct}
...
ggsave(batch2_sct_umap_plot / batch2_sct_umap_split_plot,
       ...
       width = 20, height = 14)
ggsave(ctrl_batch1_sct_umap_plot | ctrl_batch2_sct_umap_plot,
       file = paste0(directory_output, "umap_ctrl_sct.png"),
       width = 20, height = 14)
...
rm(ctrl_batch1, ctrl_batch2, ctrl_batch1_sct_umap_plot, ctrl_batch2_sct_umap_plot)
gc()
...
```{r, Focus on CTRL - Ind batch log, fig.width = 10, fig.height = 7}

ctrl_batch1 = subset(merged_log_batch1, orig.ident == "CTRL")
ctrl_batch2 = subset(merged_log_batch2, orig.ident == "CTRL2")

# Show all conditions independently
ctrl_batch1_log_umap_plot = DimPlot(object = ctrl_batch1, 
                                    reduction = "umap",
                                    group.by = "orig.ident",
                                    cols = color_code)
ctrl_batch2_log_umap_plot = DimPlot(object = ctrl_batch2, 
                                    reduction = "umap",
                                    group.by = "orig.ident",
                                    cols = color_code)

ctrl_batch1_log_umap_plot | ctrl_batch2_log_umap_plot

```

```{r, Save outputs - Ind batch log}
...
ggsave(batch2_log_umap_plot / batch2_log_umap_split_plot,
       ...
       width = 20, height = 14)
ggsave(ctrl_batch1_log_umap_plot | ctrl_batch2_log_umap_plot,
       file = paste0(directory_output, "umap_ctrl_log.png"),
       width = 20, height = 14)
...
rm(ctrl_batch1, ctrl_batch2, ctrl_batch1_log_umap_plot, ctrl_batch2_log_umap_plot)
gc()
...
```{r, Save outputs - All batches sct}
...
```{r, Save outputs - All batches log}
