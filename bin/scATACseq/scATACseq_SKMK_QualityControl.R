...
Usage:
  scATACseq_SKMK_QualityControl.R [options] <cond> <seurat_obj> <output_seurat> <output_seurat_filtered> <output_plots> <output_tab>
...
ggsave(plot = arrangeGrob(grobs = list_graph, 
         ...
         width = 40, height = 40)
# saveRDS(object = list_graphs, file = arguments$output_plotObject)
