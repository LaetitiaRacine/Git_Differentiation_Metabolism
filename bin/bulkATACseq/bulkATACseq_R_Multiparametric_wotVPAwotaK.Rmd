---
title: "bulkATACseq_R_Multiparametric_wotVPAwotaK"
...
dir.create(path = paste0(directory, "exp/bulkATACseq_R_Multiparametric_wotVPA_wotaK/"))
dir.create(path = paste0(directory, "exp/bulkATACseq_R_Multiparametric_wotVPA_wotaK/", 
                         current_date))
directory_output = paste0(directory, "exp/bulkATACseq_R_Multiparametric_wotVPA_wotaK/", 
                          current_date, "/")
...
count_df = count_df %>% dplyr::select(!str_subset(colnames(count_df), "aK"))
...
#        filename = paste0(directory_output, "ATAC_pca_samplesWoT_VPA_aK.png"),
#        width = 16*0.75, height = 9*0.75)
# 
ggsave(plot = plot_pca,
       filename = paste0(directory_output, "ATAC_pca_samplesWoT_VPA_aK_n1.svg"),
       width = 16*0.75, height = 9*0.75)
ggsave(plot = plot_pca,
       filename = paste0(directory_output, "ATAC_pca_samplesWoT_VPA_aK_n2.svg"),
       width = 10*0.75, height = 9*0.75)
ggsave(plot = plot_pca,
       filename = paste0(directory_output, "ATAC_pca_samplesWoT_VPA_aK_n3.svg"),
       width = 9*0.75, height = 9*0.75)


ggsave(plot = plot_pca,
       filename = paste0(directory_output, "ATAC_pca_samplesWoT_VPA_aK_n4.svg"),
       width = 11*0.75, height = 8*0.75)
